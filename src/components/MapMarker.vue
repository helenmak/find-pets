<template>
<div class="marker">
  <svg height="32px" style="enable-background:new 0 0 20 32;" viewBox="0 0 20 32" width="20px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
    <g id="Layer_1"/>
    <g id="map_x5F_pin_x5F_fill">
      <g>
        <g>
          <path 
            d="M17.07,2.93c-3.906-3.906-10.234-3.906-14.141,0c-3.906,3.904-3.906,10.238,0,14.141     
